...
the top risk for LLM applications \cite{owasp}. The attack class spans direct
...
\cite{protectai,meta2025,inan2023,li2025,instructdetector,jbshield}.
...
agentic deployments \cite{liu2024,owasp}.
...
ProtectAI's DeBERTa-v3 injection models \cite{protectai}, Deepset's injection
classifier \cite{deepset}, Meta's Llama Prompt Guard~2 \cite{meta2025},
PIGuard \cite{li2025}, and the generative Llama Guard \cite{inan2023}. These
...
sets such as NotInject \cite{li2025}. We observe the same failure mode in our
...
\label{sec:l1}
L1 audits raw text with a fine-tuned
ProtectAI/DeBERTa-v3-base-prompt-injection-v2 classifier
\cite{protectai,he2023}. Inputs longer than the encoder window are split into
...
\textbf{train} split of Deepset's prompt-injections dataset \cite{deepset}
...
\midrule
deepset/prompt-injections \cite{deepset} & train & 546 & binary labels (203 positive)\\
deepset/prompt-injections \cite{deepset} & test & 116 & held-out (60 inj.\ / 56 benign)\\
...
2025. [Online]. Available: \url{https://owasp.org/www-project-top-10-for-large-language-model-applications/}
...
[Online]. Available: \url{https://huggingface.co/datasets/deepset/prompt-injections}

\bibitem{meta2025}
Meta AI, ``Llama Prompt Guard 2,'' model card, 2025. [Online]. Available:
\url{https://developer.meta.com/ai/docs/model-cards-and-prompt-formats/prompt-guard/}
...
\emph{Findings of EMNLP}, 2025, arXiv:2505.06311.

\bibitem{jbshield}
S. Zhang, Y. Wang, W. Li, et al., ``JBShield: Defending large language models
from jailbreak attacks through activated concept analysis and manipulation,''
in \emph{Proc. USENIX Security Symposium}, 2025, arXiv:2502.07557.

\bibitem{fomin2026}
M. Fomin, ``When benchmarks lie: Evaluating malicious prompt classifiers under
true distribution shift,'' arXiv:2602.14161, 2026.
...
multimodal computer-use agents,'' arXiv:2606.22864, 2026.
...
Recognition (CVPR)}, 2001, pp. I-511--I-518.
